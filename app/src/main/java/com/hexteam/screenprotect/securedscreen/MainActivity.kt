...
import com.hexteam.screenprotect.secureui.rememberSecurityModeStore
        ...
        setContent {
            SecurityDemoTheme {
                ...
                HomeScreen(
                    ...
                    openAttackerApp = {
                        val launchIntent = packageManager.getLaunchIntentForPackage("com.hexteam.screenprotect.attacker")
